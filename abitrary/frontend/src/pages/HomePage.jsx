...
const HomePage = () => {
  return (
    <Layout>
      <Card title={<Typography.Title>Welcome to ABITRARY!</Typography.Title>}>
        <Typography.Title level={2}>What is ABIRARY?</Typography.Title>
        <Typography.Paragraph>
          ABITRARY는 AB테스트를 위한 라우팅 툴입니다. 일반적인 비즈니스 모델에서
          사용할 수 있도록 ABITRARY는 별도의 연동과정 없이 AB테스팅을 운영할 수
